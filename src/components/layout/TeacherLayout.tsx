...
import { Book, Presentation, LayoutDashboard, ClipboardList, FileText, CheckSquare } from "lucide-react";
...
const teacherNavItems = [
  ...
  { to: '/app/teacher/quizzes', icon: CheckSquare, label: 'Manage Quizzes' },
